_base_ = ["./input_random_fixed_50pct_adapter_irregular_dense_control_pdrop0.py"]
...
work_dir = "exps/thumos/adatad/input_random_fixed_50pct_adapter_irregular_dense_control_pdrop0_n16r4"

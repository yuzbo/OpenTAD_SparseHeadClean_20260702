_base_ = ["./e2e_thumos_videomae_s_768x1_160_frozen_n16r4.py"]
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                legacy_selected_axis_gt_drop_diagnostic=True,
...
work_dir = "exps/thumos/adatad/input_random_fixed_50pct_0410_exact_n16r4"

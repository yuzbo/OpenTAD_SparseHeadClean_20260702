...
- 2026-07-06 implementation update after official review:
  ...
  - Added a Linux behavior regression test for selected-axis post-processing: it monkeypatches NMS and verifies selected-axis proposals are converted to native coordinates before NMS and not converted a second time during seconds conversion. Also hardened oracle/weighted helper paths to clear stale dropped-GT state on native-axis branches.

...
CONFIG="configs/adatad/thumos/input_random_fixed_50pct_native_physical_point_single_video_fulllen_overfit.py"
NAME="input_random_fixed_50pct_native_physical_point_single_video_fulllen_overfit"
GPU_ID="${GPU_ID:-0}"

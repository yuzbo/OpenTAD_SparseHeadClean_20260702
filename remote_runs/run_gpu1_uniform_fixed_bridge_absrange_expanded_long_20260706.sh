...
LOG_DIR="$ROOT/logs/gpu1_uniform_fixed_bridge_absrange_expanded_long"
RUN_TAG="${RUN_TAG:-gpu1_uniform_fixed_bridge_absrange_expanded_long_$(date +%Y%m%d_%H%M%S)}"
...
CFG="configs/adatad/thumos/input_uniform_fixed_50pct_adapter_irregular_bridge_hard_linear_absrange_expanded_n16r4.py"
EXP_ID="${EXP_ID:-1}"
PORT="${PORT:-32328}"
...
log_msg "uniform_fixed bridge absrange_expanded long-train start on $(hostname) cfg=$CFG exp_id=$EXP_ID"
log_msg "root=$ROOT"
...
print("compare_to", "random_fixed_absrange_expanded_pending", "equal_interval_reference_approx_65")
